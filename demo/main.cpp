...
int main() {
   ...
   //TODO: revise this value accordisudo mbed compile --source . --source ~/ee2405/mbed-os-build/ -m B_L4S5I_IOT01A -t GCC_ARM -fng to your result
   servo_control(-22.208);
